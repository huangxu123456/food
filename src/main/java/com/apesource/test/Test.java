                ...
                while (true) {
                    ...
                    switch (m) {
                        ...
                        case 1: {
                            ...
                            addresses.forEach(ad -> System.out.println(ad.getAddId() + "\t" + ad.getAddress() + "\t" + ad.getUserId() + "\t" + ad.getUser().getUserName()));
                            System.out.println("================================================");
                        ...
                        case 2: {
                            ...
                            switch (ding) {
                                case 1: {
                                    ...
                                    System.out.println("订单编号\t 用户编号\t 用户名\t 菜单编号\t 菜品名称\t 菜单价格\t 菜品积分\t 支付状态\t 订单日期\t评论 \t评分");
                                    ...
                                    for (Order1 o : order1s
                                        ...
                                        if (o.getOrderType() == 1) {
                                            ...
                                            //+"\t"+o.getComment().getComComment()+"\t"+o.getComment().getComStar()
                                        }
                                    }
                                    //System.out.println();
                                    break;
